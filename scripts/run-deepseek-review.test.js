...
describe("fetchPrDiff", () => {
  ...
  it("should fetch the PR diff with the correct headers", async () => {
    ...
    expect(fetchSpy).toHaveBeenCalledWith("https://api.github.com/repos/owner/repo/pulls/42", {
      headers: {
...
describe("fetchDeepSeekReview", () => {
  ...
  it("should throw on DeepSeek API error", async () => {
    ...
    await expect(fetchDeepSeekReview("diff", "bad-key")).rejects.toThrow("DeepSeek API error: 401");
  });
